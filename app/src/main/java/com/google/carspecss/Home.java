...
public class Home extends AppCompatActivity
    ...
    //On click search method
    public void Search(View view) {
        Intent intent = new Intent(this, Specifications.class);
        EditText carInput = (EditText) findViewById(R.id.carInput);
        String carName = carInput.getText().toString();
        intent.putExtra(EXTRA_MESSAGE, carName);
